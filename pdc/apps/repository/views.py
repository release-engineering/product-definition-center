...
class MultiDestinationViewSet(PDCModelViewSet):
    """
    Multi-destinations (multi-product) for mapping files for a global
    component from an origin repository to a destination repository.
    """

    queryset = models.MultiDestination.objects.all()
